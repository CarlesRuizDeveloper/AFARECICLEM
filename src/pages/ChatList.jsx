...
const ChatList = () => {
    ...
    return (
        <div className="flex h-screen bg-gray-50">
            <div className="w-1/3 bg-white p-6 border-r border-gray-200 shadow-lg">
                <h2 className="text-2xl font-bold text-gray-800 mb-6">Conversaciones</h2>
            ...
            <div className="w-2/3 bg-white p-6 flex justify-center items-center">
                <h2 className="text-xl font-semibold text-gray-600">Selecciona una conversación para ver los mensajes</h2>
            </div>
        </div>
    );
};
